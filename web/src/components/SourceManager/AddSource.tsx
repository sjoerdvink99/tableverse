...
import { fetchProfiles, registerSource } from "../../lib/api";
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (tab === "file") {
        ...
        if (cloudAccessKey || cloudSecretKey || cloudRegion || cloudEndpoint) {
          credentials = {
            access_key: cloudAccessKey.trim() || undefined,
            secret_key: cloudSecretKey.trim() || undefined,
        ...
        <form onSubmit={handleSubmit} style={{ display: "flex", flexDirection: "column", gap: 12 }}>
          ...
          <div style={{ display: "flex", gap: 8, justifyContent: "flex-end", marginTop: 4 }}>
            <button
              type="button"
              onClick={onCancel}
              style={{ padding: "7px 14px", fontSize: 13, background: "var(--c-surface)", border: "1px solid var(--c-border)", borderRadius: 4, cursor: "pointer", color: "var(--c-text-2)" }}
            >
              Cancel
            </button>
            <button
              ...
              style={{ padding: "7px 14px", fontSize: 13, background: "var(--c-accent)", color: "#fff", border: "none", borderRadius: 4, cursor: "pointer", opacity: isSubmitDisabled() ? 0.6 : 1 }}
            >
